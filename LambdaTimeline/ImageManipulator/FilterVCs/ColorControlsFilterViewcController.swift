...
class ColorControlsFilterViewcController: UIViewController {
...
//        filter2.brightness = brightnessSlider.value
        ...
        filter.setValue(NSNumber(value: saturationSlider.value), forKey: kCIInputSaturationKey) // k = constant in Objective-C
        filter.setValue(NSNumber(value: brightnessSlider.value), forKey: kCIInputBrightnessKey)
        filter.setValue(NSNumber(value: contrastSlider.value), forKey: kCIInputContrastKey)
...
extension ColorControlsFilterViewcController: UIImagePickerControllerDelegate {
...
extension ColorControlsFilterViewcController: UINavigationControllerDelegate {
