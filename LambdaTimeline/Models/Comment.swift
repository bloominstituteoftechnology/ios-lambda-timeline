...
class Comment: FirebaseConvertible, Equatable {
    ...
    init(text: String?, author: Author, audioURL: URL? = nil, timestamp: Date = Date()) {
        self.text = text
        self.author = author
    ...
    init?(dictionary: [String : Any]) {
        guard let text = dictionary[Comment.textKey] as? String,
            ...
            let audioURL = dictionary[Comment.audioKey] as? URL else { return nil }
