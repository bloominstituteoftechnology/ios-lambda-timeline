...
class PostController {
    ...
    func addAudioComment(url: URL, to post: inout Post){
        guard let user = Auth.auth().currentUser, let author = Author(user: user) else {return}
        let comment = Comment(text: "", author: author, audioURL: url)
