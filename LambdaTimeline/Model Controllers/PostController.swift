...
class PostController {
    ...
    func createPost(with title: String, ofType mediaType: MediaType, mediaData: Data, ratio: CGFloat? = nil, at geotag: CLLocationCoordinate2D? = nil, completion: @escaping (Bool) -> Void = { _ in }) {
        ...
        store(mediaData: mediaData, mediaType: mediaType) { (mediaURL) in
            ...
            let imagePost = Post(title: title, mediaURL: mediaURL, ratio: ratio, mediaType: mediaType, author: author, geotag: geotag)
