...
class PostController {
    ...
    func createPost(with title: String, ofType mediaType: MediaType, mediaData: Data, ratio: CGFloat? = nil, atGeotag geotag: CLLocationCoordinate2D?, completion: @escaping (Bool) -> Void = { _ in }) {
