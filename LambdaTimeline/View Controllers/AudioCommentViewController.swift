...
//
//    @IBAction func recordButtonPressed(_ sender: Any) {
//        audioController.recordToggle()
//        audioController.audioRecorder?.delegate = self
//        updateViews()
//    }
//
//    private func updateViews() {
//        let playButtonTitle = audioController.isPlaying ? "Pause" : "Play"
//        playButton.setTitle(playButtonTitle, for: .normal)
//
...
//        timeSlider.value = Float(elapsedTime)
//
//        let recordButtonTitle = audioController.isRecording ? "Stop" : "Record"
//        recordButton.setTitle(recordButtonTitle, for: .normal)
//
//        let timeRemaining = duration - elapsedTime
//        timeRemainingLabel.text = timeFormatter.string(from: timeRemaining)
...
//        // TODO: Update player to load our audio file
//        print("Finished Recording")
//        if let recordURL = audioController.recordURL {
//            audioController.audioPlayer = try! AVAudioPlayer(contentsOf: recordURL) // FIXME: try!
