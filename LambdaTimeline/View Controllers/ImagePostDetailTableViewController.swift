...
class ImagePostDetailTableViewController: UITableViewController {
    ...
    @IBAction func createComment(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "New comment", message: "What type of comment would you like to create?", preferredStyle: .actionSheet)
        ...
        let voicePostAction = UIAlertAction(title: "Voice", style: .default) { _ in
            ...
            let viewController = storyboard.instantiateViewController(withIdentifier: "AudioCommentController") as! AudioCommentViewController
...
extension ImagePostDetailTableViewController: VoiceCommentDelegate {
    func reloadData() {
