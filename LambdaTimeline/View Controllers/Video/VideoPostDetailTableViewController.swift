...
class VideoPostDetailTableViewController: UITableViewController, UIPopoverPresentationControllerDelegate, AudioCommentTableViewCellDelegate, AVAudioPlayerDelegate {
