...
//  ImageFilterEditor
//
//  Created by Christian Lorenzo on 5/7/20.
...
//        }
//        do {
//            var myNewImage = String.init(describing: scaledImage)
//            try data.write(to: directory.appendingPathComponent(String.init(describing: scaledImage))!)
//            return true
//        } catch {
...
//    }
    ...
    private func adjustExposure(_ image: UIImage) -> UIImage? {
        ...
        //Setting values / getting values form CoreImage
