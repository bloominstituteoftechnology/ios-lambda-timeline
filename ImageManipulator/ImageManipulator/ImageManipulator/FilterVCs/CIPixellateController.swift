...
class PixelFilterViewController: UIViewController {
    ...
    private func filterImage(_ image: UIImage) -> UIImage? {
        ...
        // Filter image
        let filter = CIFilter(name: "CIPixellate")! // built-in filter from Apple
...
//        filter2.brightness = brightnessSlider.value
        ...
        filter.setValue(NSNumber(value: scaleSlider.value), forKey: kCIInputScaleKey)
...
extension PixelFilterViewController: UIImagePickerControllerDelegate {
...
extension PixelFilterViewController: UINavigationControllerDelegate {
